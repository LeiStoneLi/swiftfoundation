...
//  MyLocations
//
//  Created by SrearAlex on 2017/1/17.
...
//                statusMessage = "Tap 'Get My Location' to Start"
    ...
    /*
     ...
     if let s = placemark.subThoroughfare {//门牌号码
     print("subThroughfare: \(s)")
     line1 += s + " "
     }
     
     if let s = placemark.thoroughfare {//大道，街道名字
     line1 += s
     }
     
     var line2 = ""
     
     if let s = placemark.locality {//市
     line2 += s + " "
     }
     
     if let s = placemark.administrativeArea {//州，省
     line2 += s + " "
     }
